...
class SellerProductSearch extends StatefulWidget {
  final keyword, id;
  SellerProductSearch(this.keyword, this.id);
  @override
  _SellerProductSearch createState() => new _SellerProductSearch();
}

class _SellerProductSearch extends State<SellerProductSearch> {
  void initState() {
    super.initState();
      ...
      if (response.statusCode == 200) {
        ...
        if (json.decode(response.body)['status']) {
          Navigator.pushReplacement(
                  ...
                  new MaterialPageRoute(
                      builder: (context) =>
                          new SellerProductSearch(keyword.text, widget.id)))
              .then((value) {
