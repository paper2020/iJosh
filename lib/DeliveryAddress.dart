...
import 'package:eram_app/AddNewAddress1.dart';
import 'package:eram_app/EditdeliveryAddress1.dart';
...
class _DeliveryAddress extends State<DeliveryAddress> {
  ...
  Future<void>  deliveryaddressList() async{
    ...
    if(json.decode(response.body)['status']) {
      ...
      for (int i = 0; i < json.decode(response.body)['data'].length; i++)
        address.add(json.decode(response.body)['data'][i]);
    }
    else
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text("Delivery Address",style: GoogleFonts.poppins(textStyle:TextStyle(color:Color(0xFF000000),fontSize:16,fontWeight: FontWeight.w600),)),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () {
                        setState(() async{
                         await Navigator.push(context, new MaterialPageRoute(builder: (context) => AddNewAddress1()));
                          address.clear();
                                    ...
                                    child:FlatButton(
                                      ...
                                      onPressed: () async{
                                       await Navigator.push(
                                            ...
                                            builder: (context) => new EditdeliveryAddress1(address[index],address[index]['_id'])));
                                       address.clear();
                                      await deliveryaddressList();
