...
class AddNewAddress1 extends StatefulWidget {
  @override
  _AddNewAddress1 createState() => _AddNewAddress1();
}

class _AddNewAddress1 extends State<AddNewAddress1> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (json.decode(response.body)['status']) {
          ...
          // await Navigator.pushReplacement(context,new MaterialPageRoute(builder: (context)=>new DeliveryAddress()));
        } else {
