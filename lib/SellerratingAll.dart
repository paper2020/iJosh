...
class SellerallRating extends StatefulWidget {
  final sid;
  SellerallRating(this.sid);
  @override
  _SellerallRating createState() => _SellerallRating();
}
class _SellerallRating extends State<SellerallRating> {
