...
class CategorySearch extends StatefulWidget {
  final serviceid, keyword;
  CategorySearch(this.serviceid, this.keyword);
  @override
  _CategorySearch createState() => new _CategorySearch();
}
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          Row(children: [
                                                                            ...
                                                                            Text(product[index]['rating'].toString(),
                                                                                style: GoogleFonts.poppins(textStyle: TextStyle(color: Color(0xFF9B9B9B), fontSize: 11, fontWeight: FontWeight.w400))),
                                                                          ]),
                                                                          // SizedBox(
                                                                          //   height:5,
                                                                          // ),
      ...
      if (response.statusCode == 200) {
        ...
        if (json.decode(response.body)['status']) {
          Navigator.pushReplacement(
                  ...
                  new MaterialPageRoute(
                      builder: (context) =>
                          new CategorySearch(widget.serviceid, keyword.text)))
              .then((value) {
